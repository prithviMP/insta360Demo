...
import com.arashivision.sdk.demo.activity.MediaFilesActivity;
import androidx.fragment.app.FragmentManager;
import androidx.fragment.app.FragmentTransaction;

public class CustomDemoActivity extends AppCompatActivity implements ICameraChangedCallback,
...
protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    findViewById(R.id.nav_gallery).setOnClickListener(v -> {
        startActivity(new Intent(CustomDemoActivity.this, MediaFilesActivity.class));
    });
    ...
    findViewById(R.id.nav_camera).setOnClickListener(v -> {
        if (isCameraConnected()) {
            ...
            Toast.makeText(CustomDemoActivity.this, "Camera is not connected", Toast.LENGTH_SHORT).show();
        }
    });

    FragmentManager fragmentManager = getSupportFragmentManager();
    FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
    fragmentTransaction.replace(R.id.page_container, new HomeFragment());
    ...
    private void bindNormalViews() {
        ...
        Button btnMyScans = findViewById(R.id.btn_my_scans);
        Button btnSaved = findViewById(R.id.btn_saved);
        Button btnSharedWithMe = findViewById(R.id.btn_shared_with_me);

        if (btnMyScans != null) {
            btnMyScans.setOnClickListener(v -> {
                // Handle My Scans button click
            });
        } else {
            Log.e("CustomDemoActivity", "View with ID 'btn_my_scans' not found");
        }
        ...
        if (btnSaved != null) {
            ...
            Log.e("CustomDemoActivity", "View with ID 'btn_saved' not found");
        }

        if (btnSharedWithMe != null) {
            btnSharedWithMe.setOnClickListener(v -> {
                // Handle Shared with Me button click
            });
        } else {
            Log.e("CustomDemoActivity", "View with ID 'btn_shared_with_me' not found");
        }
    ...
    private void bindPlayerViews() {
        ...
        if (mCapturePlayerView != null) {
            ...
            Log.e("CustomDemoActivity", "View with ID 'player_capture' not found");
        }

        mRgCaptureMode = findViewById(R.id.rg_capture_mode);
        if (mRgCaptureMode != null) {
            ...
            Log.e("CustomDemoActivity", "View with ID 'rg_capture_mode' not found");
        }

        mBtnCameraWork = findViewById(R.id.btn_camera_work);
        if (mBtnCameraWork != null) {
            ...
            Log.e("CustomDemoActivity", "View with ID 'btn_camera_work' not found");
        }
    }
